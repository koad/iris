...
- **Authority chain:** koad → Juno → iris
- **Cryptographic identity:** Keys in ~/.iris/id/
- **Located at:** $HOME = ~/.iris
- **Repository:** koad/iris (GitHub)
